 ...
 *
 * @package   local_edwiser_submission
 ...
 * @return bool
 */
function local_edwiser_submission_comment_validate(stdClass $options) {
    global $USER, $CFG, $DB;
 ...
 * @return array
 */
function local_edwiser_submission_comment_permissions(stdClass $options) {
 ...
 */
function local_edwiser_submission_comment_display($comments, $options) {
 ...
 */
function local_edwiser_submission_comment_add(stdClass $comment, stdClass $param) {

    global $DB;
    if ($comment->commentarea == 'submission_comments_upgrade') {
        $submissionid = $comment->itemid;
        $submission = $DB->get_record('efb_form_data', array('id' => $submissionid));
